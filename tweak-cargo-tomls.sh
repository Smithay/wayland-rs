...
sed -i.bak 's/wayland-sys = { version = "[0-9\.\^]*"/wayland-sys = { path = "..\/wayland-sys"/' ./wayland-server/Cargo.toml
sed -i.bak 's/wayland-scanner = { version = "[0-9\.\^]*"/wayland-scanner = { path = "..\/scanner"/' ./wayland-server/Cargo.toml
