...
mod generated {
    ...
    pub mod client {
        pub mod interfaces {
            pub use wayland_server::protocol_interfaces::wl_surface_interface;
        ...
        pub mod api {
            ...
            #[doc(hidden)] pub use wayland_client::protocol::wl_surface;
    ...
    pub mod server {
        ...
        pub mod api {
            ...
            #[doc(hidden)] pub use super::interfaces;
            #[doc(hidden)] pub use wayland_server::protocol::wl_surface;
            include!(concat!(env!("OUT_DIR"), "/viewporter_server_api.rs"));
        }
    }
}
